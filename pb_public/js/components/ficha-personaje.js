...
class FichaPersonaje extends ComponenteBase {
  ...
  renderizarContenido() {
    return html`
      <div class="card-content">
        ...
        ${this.renderizarSeccionLogros()} ${this.renderizarSeccionMedallas()}
  ...
  renderizarSeccionAtributos() {
    ...
    return html`
      <p class="subtitle ${colorTitulo} mt-5 mb-4">Atributos</p>
  ...
  renderizarSeccionAtributosSociales() {
    ...
    return html`
      <p class="subtitle ${colorTitulo} mt-5 mb-4">Atributos sociales</p>
  ...
  renderizarSeccionAptitudesLucha() {
    ...
    return html`
      <p class="subtitle ${colorTitulo} mt-5 mb-4">Aptitudes</p>
  ...
  renderizarSeccionAptitudesSocial() {
    ...
    return html`
      <p class="title ${colorTitulo} is-7 is-uppercase mt-5 mb-4">Social</p>
  ...
  renderizarSeccionAptitudesSaber() {
    ...
    return html`
      <p class="title ${colorTitulo} is-7 is-uppercase mt-5 mb-4">Saber</p>
  ...
  renderizarSeccionLogros() {
    ...
    return html`
      <p class="subtitle ${colorTitulo} mt-5 mb-4">Logros</p>
  ...
  renderizarSeccionMedallas() {
    ...
    return html`
      <p class="subtitle ${colorTitulo} mt-6 mb-4">Estuche de medallas</p>
  ...
  renderizarSeccionInventario() {
    ...
    return html`
      ...
      <div class="box">En desarrollo...</div>
    `;
  }
